...
begin
  ...
  if v_username is null then
    ...
    insert into ecm_store set store_id=v_uid, owner_name=v_uid, owner_card='', region_id=2, region_name='中国', sgrade=1, domain='', state=1, add_time=1443279642, im_qq=i_qq, mk_name=i_mk_name, shop_mall=i_shop_mall, floor=5, address=i_address, dangkou_address=i_dangkou_address, store_name=i_store_name, see_price=i_price, im_ww=i_im_ww, shop_http=i_shop_http, has_link=0, serv_refund=0, serv_exchgoods=0, serv_sendgoods=0, serv_probexch=0, serv_deltpic=0, serv_modpic=0, serv_golden=0, last_update=1443279642;
