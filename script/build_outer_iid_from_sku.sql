...
drop procedure build_outer_iid_from_sku$$

create procedure build_outer_iid_from_sku(
...
begin
  ...
  goods_loop: loop
    ...
    select sku into v_huohao from ecm_goods_spec where goods_id = v_goods_id limit 1;

    if v_price_huohao is not null and v_huohao is not null and v_huohao != '' then
