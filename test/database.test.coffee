...
describe 'database', () ->
  ...
  describe '#updateGoods', ->
    ...
    it 'should be 1 spec', ->
      ...
      assert.isTrue db.pool.query.calledWith "update ecm_goods set goods_name = 'title', price = 15, taobao_price = 30, description = 'desc', spec_name_1 = '颜色分类', spec_name_2 = '', spec_pid_1 = 1627207, spec_pid_2 = 0, spec_qty = 1, realpic = 1 where good_http = 'good http';update ecm_goods set default_image = 'default image' where good_http = 'good http' and (default_image = '' or default_image = 'undefined' or locate('vvic.com', default_image) != 0);"
